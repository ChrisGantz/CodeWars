...
*/
// v.v why would you ever think of a question like this??!
...
function gap2(g, m, n) {
  ...
  for (let tempM = m; tempM <= n; tempM++)
    if (isPrime(tempM)) {
      if (tempM - lastPrime == g) {
        return [lastPrime, tempM];
      }
      else { 
      lastPrime = tempM;
      }
...
console.log(gap2(6, 100, 110));
console.log(gap2(2, 5, 10));

// this one does not work V
function gap(g, m, n) {
  // your code
